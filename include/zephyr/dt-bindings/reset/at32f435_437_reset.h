...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_RESET_AT32F435_437_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_RESET_AT32F435_437_H_
...
#define AT32_RESET_GPIOE      AT32_RESET_CONFIG(AHB1RST, 4)
#define AT32_RESET_GPIOF      AT32_RESET_CONFIG(AHB1RST, 5)
#define AT32_RESET_GPIOG      AT32_RESET_CONFIG(AHB1RST, 6)
#define AT32_RESET_GPIOH      AT32_RESET_CONFIG(AHB1RST, 7)
#define AT32_RESET_CRC        AT32_RESET_CONFIG(AHB1RST, 12)
#define AT32_RESET_EDMA       AT32_RESET_CONFIG(AHB1RST, 21)
#define AT32_RESET_DMA1       AT32_RESET_CONFIG(AHB1RST, 22)
#define AT32_RESET_DMA2       AT32_RESET_CONFIG(AHB1RST, 24)
#define AT32_RESET_EMAC       AT32_RESET_CONFIG(AHB1RST, 25)
#define AT32_RESET_USBFS2     AT32_RESET_CONFIG(AHB1RST, 29)

/* AHB2 peripherals */
#define AT32_RESET_DVP        AT32_RESET_CONFIG(AHB2RST, 0)
#define AT32_RESET_USBFS      AT32_RESET_CONFIG(AHB2RST, 7)
#define AT32_RESET_SDIO1      AT32_RESET_CONFIG(AHB2RST, 15)

/* AHB3 peripherals */
#define AT32_RESET_XMC        AT32_RESET_CONFIG(AHB3RST, 0)
#define AT32_RESET_QSPI1      AT32_RESET_CONFIG(AHB3RST, 1)
#define AT32_RESET_QSPI2      AT32_RESET_CONFIG(AHB3RST, 14)
#define AT32_RESET_SDIO2      AT32_RESET_CONFIG(AHB3RST, 15)
...
#define AT32_RESET_TIMER8     AT32_RESET_CONFIG(APB2RST, 1)
...
#define AT32_RESET_ADC2       AT32_RESET_CONFIG(APB2RST, 9)
#define AT32_RESET_ADC3       AT32_RESET_CONFIG(APB2RST, 10)
#define AT32_RESET_SPI1       AT32_RESET_CONFIG(APB2RST, 12)
#define AT32_RESET_SPI4       AT32_RESET_CONFIG(APB2RST, 13)
...
#define AT32_RESET_TIMER20    AT32_RESET_CONFIG(APB2RST, 20)
#define AT32_RESET_ACC        AT32_RESET_CONFIG(APB2RST, 29)

/** @} */

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_RESET_AT32F435_437_H */
