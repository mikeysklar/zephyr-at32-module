...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F435_437_CLOCKS_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F435_437_CLOCKS_H_
...
#define AT32_CLOCK_GPIOE      AT32_CLOCK_CONFIG(AHB1EN, 4)
#define AT32_CLOCK_GPIOF      AT32_CLOCK_CONFIG(AHB1EN, 5)
#define AT32_CLOCK_GPIOG      AT32_CLOCK_CONFIG(AHB1EN, 6)
#define AT32_CLOCK_GPIOH      AT32_CLOCK_CONFIG(AHB1EN, 7)
#define AT32_CLOCK_CRC        AT32_CLOCK_CONFIG(AHB1EN, 12)
#define AT32_CLOCK_EDMA       AT32_CLOCK_CONFIG(AHB1EN, 21)
#define AT32_CLOCK_DMA1       AT32_CLOCK_CONFIG(AHB1EN, 22)
#define AT32_CLOCK_DMA2       AT32_CLOCK_CONFIG(AHB1EN, 24)
#define AT32_CLOCK_EMAC       AT32_CLOCK_CONFIG(AHB1EN, 25)
#define AT32_CLOCK_EMACTX     AT32_CLOCK_CONFIG(AHB1EN, 26)
#define AT32_CLOCK_EMACRX     AT32_CLOCK_CONFIG(AHB1EN, 27)
#define AT32_CLOCK_EMACPTP    AT32_CLOCK_CONFIG(AHB1EN, 28)
#define AT32_CLOCK_USBFS2     AT32_CLOCK_CONFIG(AHB1EN, 29)

/* AHB2 peripherals */
#define AT32_CLOCK_DVP        AT32_CLOCK_CONFIG(AHB2EN, 0)
#define AT32_CLOCK_USBFS      AT32_CLOCK_CONFIG(AHB2EN, 7)
#define AT32_CLOCK_SDIO1      AT32_CLOCK_CONFIG(AHB2EN, 15)

/* AHB3 peripherals */
#define AT32_CLOCK_XMC        AT32_CLOCK_CONFIG(AHB3EN, 0)
#define AT32_CLOCK_QSPI1      AT32_CLOCK_CONFIG(AHB3EN, 1)
#define AT32_CLOCK_QSPI2      AT32_CLOCK_CONFIG(AHB3EN, 14)
#define AT32_CLOCK_SDIO2      AT32_CLOCK_CONFIG(AHB3EN, 15)
...
#define AT32_CLOCK_TIMER8     AT32_CLOCK_CONFIG(APB2EN, 1)
...
#define AT32_CLOCK_ADC2       AT32_CLOCK_CONFIG(APB2EN, 9)
#define AT32_CLOCK_ADC3       AT32_CLOCK_CONFIG(APB2EN, 10)
#define AT32_CLOCK_SPI1       AT32_CLOCK_CONFIG(APB2EN, 12)
#define AT32_CLOCK_SPI4       AT32_CLOCK_CONFIG(APB2EN, 13)
...
#define AT32_CLOCK_TIMER20    AT32_CLOCK_CONFIG(APB2EN, 20)
#define AT32_CLOCK_ACC        AT32_CLOCK_CONFIG(APB2EN, 29)

/** @} */

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F435_437_CLOCKS_H_ */
